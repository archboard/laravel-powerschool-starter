<template>
  <component
    :is="component"
    class="border border-transparent overflow-hidden font-medium shadow hover:shadow-none focus:outline-none transition ease-in-out duration-150 relative text-center justify-center items-center disabled:cursor-not-allowed focus:ring-2 focus:ring-offset-2"
    :class="[
      buttonSize,
      buttonColor,
      {
...
export default {
  ...
  data () {
    return {
      ...
      colors: {
        primary: 'text-white bg-brand-primary focus:ring-brand-primary active:bg-brand-primary disabled:bg-gray-500',
