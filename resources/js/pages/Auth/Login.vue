  ...
  <Layout>
    <div>
      <span v-if="tenant.allow_oidc_login" class="rounded-md shadow-sm self-start flex w-full">
        <a href="/auth/powerschool/oidc/authenticate" class="px-4 py-3 text-base leading-6 flex w-full border border-transparent font-medium rounded-md text-white focus:outline-none transition ease-in-out duration-150 items-center justify-center text-white bg-[#00427c] hover:bg-[#003463] focus:ring focus:ring-[#006bc9] focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition">
